...
WEIGHTS_ROOT="/ptmp/pierocor/hvd_out/resume/weights"  # Replace by a folder where you have writing access (HVD folder)
LOGS_ROOT="/ptmp/pierocor/hvd_out/resume/logs"  # Replace by a folder where you have writing access (HVD folder)
SAMPLE_ROOT="/ptmp/pierocor/hvd_out/resume/samples"  # Replace by a folder where you have writing access (HVD folder)
